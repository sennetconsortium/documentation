...
- Select the `Register entity` drop down <app-modal data-title="Click the Register entity menu link" data-body="<img alt='Click the Register entity menu link' src='./../imgs/register-entity.jpg' class='w-fixed' width='311px' height='409px' />"><i role='button' aria-label='View modal for Register entity menu link' class='js-modal link-primary fa fa-picture-o'>&nbsp;</i> </app-modal>
