...
In the event that GlobalProtect won't work for you, you can use a browser based virtual desktop environment to access the Hub.  Start by connecting your browser to <a href="https://pi.tt/vlab" target="_blank" rel="noopener noreferrer">https://pi.tt/vlab</a>. After connecting to the Virtual Environment in your browser:
 ...
 <img src="imgs/virt-desktop-crc-moonshot-icon.png" alt="Open Virtual Desktop" width="282" height="198"><br/><br/>
  2. Start a terminal by searching for "Terminal" in the Windows Search Bar, then clicking the "Terminal" application:<br/>
 <img src="imgs/virtual-desktop-start-terminal.png" alt="Start Virtual Desktop Terminal" width="716" height="605"><br/><br/>
