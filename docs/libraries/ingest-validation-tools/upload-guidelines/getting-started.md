...
![Typical data submission workflow](m/documentation/blob/bhonick/adding-getting-started-section/docs/libraries/ingest-validation-tools/upload-guidelines/SenNet%20Data%20Submission%20Overview%20Registration.drawio.png)
